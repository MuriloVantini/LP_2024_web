<x-app-layout>
    ...
    @section('content')
        <div class="relative overflow-x-auto mx-44 py-10">
            <table class="w-full rounded-lg  text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($veiculos as $veiculo)
                        <tr
                            class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 hover:cursor-pointer">
                            <th scope="row"
